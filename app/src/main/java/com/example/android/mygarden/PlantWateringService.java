...
public class PlantWateringService extends IntentService {
    ...
    private void handleActionUpdatePlantWidgets() {
        ...
        if (cursor != null && cursor.getCount() > 0) {
            ...
            showWaterButton = timeNow - wateredAt > PlantUtils.MAX_AGE_BETWEEN_WATER &&
        ...
        PlantWidgetProvider.updatePlantWidgets(this, appWidgetManager, imgRes, plantId, showWaterButton, appWidgetIds);
    }
}
