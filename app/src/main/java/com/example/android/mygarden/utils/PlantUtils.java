...
public class PlantUtils {
    ...
    public static final long MAX_AGE_BETWEEN_WATER = HOUR_MILLISECONDS * 1;
    ...
    public static int getPlantImgRes(Context context, int type, PlantStatus status, PlantSize size) {
        ...
        if (size == PlantSize.TINY) {
            resName += "_1";
        } else if (size == PlantSize.JUVENILE) {
            resName += "_2";
        } else if (size == PlantSize.FULLY_GROWN) {
            resName += "_3";
        }
